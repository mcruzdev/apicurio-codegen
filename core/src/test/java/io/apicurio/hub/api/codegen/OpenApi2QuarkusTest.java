...
public class OpenApi2QuarkusTest extends OpenApi2TestBase {
    ...
    public void testGenerateFullDifferentNamespace() throws IOException {
        ...
        super.doFullTest(generator, "_expected-full-different-ns/generated-api-" + Runtime.version().feature(), false);
    }
    ...
    public void testGitHubApisFull() throws IOException {
        doFullTest("OpenApi2QuarkusTest/github-apis-deref.json", false, "_expected-github/generated-api-" + Runtime.version().feature(), false);
    }
    ...
    public void testStrimziKafkaBridge() throws IOException {
        doFullTest("OpenApi2QuarkusTest/strimzi-kafka-bridge.json", false, "_expected-strimzi-kafka-bridge/generated-api-" + Runtime.version().feature(), false);
    }
